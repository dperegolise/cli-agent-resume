...
Portfolio file structure (these are the only files that exist):
  ...
  www/projects/project-5.md — claude-sysadmin (audited, server-enforced AI administration of a Linux VPS)
  www/projects/project-6.md — justwispr (local offline voice dictation at the cursor)
  www/projects/project-7.md — ovtr (agentic dev + project-management system for the solo multi-client operator)
  www/projects/project-8.md — routr (Go daemon routing prompts across a cascade of AI providers)
